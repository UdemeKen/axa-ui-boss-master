<template>
  <div class="app-container">
    <template>
      <div class="head-container">
        <blockquote class="my-blockquote" size="mini" style="padding-bottom: 5px;">
          ...
          <el-input v-model="query.channelId" clearable placeholder="商户ID" style="width: 110px;" class="filter-item" @change="toQuery"/>
    ...
    <el-table v-loading="loading" :data="data" size="small" border style="width: 100%;">
      ...
      <el-table-column prop="channelId" label="通道ID" min-width="90px"/>
      <el-table-column prop="channelName" label="通道名称" min-width="90px"/>
