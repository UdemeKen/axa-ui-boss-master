<template>
  <div class="app-container">
    <template>
      <div class="head-container">
        <blockquote class="my-blockquote" size="mini" style="padding-bottom: 5px;">
          <el-select v-model="query.targetId" placeholder="选择通道" filterable clearable class="filter-item" style="width:120px" @change="toQuery">
    ...
    <el-table v-loading="loading" :data="data" size="small" border style="width: 100%;">
      <el-table-column :show-overflow-tooltip="true" prop="targetName" label="通道" min-width="120px"/>
      ...
      <el-table-column prop="successIncome" label="通道收益(元)" min-width="90px">
        <template slot-scope="scope">
