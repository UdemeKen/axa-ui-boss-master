...
<script>
import { resetMchLoginPsw, resetMchDrawPsw } from '@/api/mch'
...
export default {
  ...
  methods: {
    ...
    resetLoginPsw() {
      resetMchLoginPsw({ id: this.form.id, newPwd: this.form.newPwd, repeatPwd: this.form.repeatPwd }).then(res => {
        this.resetForm()
        this.$notify({
          title: '登录密码重置成功',
          type: 'success',
    ...
    resetDrawPsw() {
      resetMchDrawPsw({ id: this.form.id, newPwd: this.form.newPwd, repeatPwd: this.form.repeatPwd }).then(res => {
        this.resetForm()
        this.$notify({
          title: '提现密码重置成功',
          type: 'success',
