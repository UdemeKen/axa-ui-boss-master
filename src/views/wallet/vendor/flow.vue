<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :show-overflow-tooltip="true" label="卡商账户" prop="venName" min-width="100px"/>
      ...
      <el-table-column label="资金类型" min-width="90px">
        <template slot-scope="scope">
          <span v-if="scope.row.amountType==0">余额</span>
          <span v-if="scope.row.amountType==1">收益</span>
          <span v-if="scope.row.amountType==2">奖金</span>
        </template>
      </el-table-column>
