...
import { getWalletStats, getPcOptions } from '@/api/payment'
...
export default {
  ...
  data() {
    return {
      sup_this: this, pageNum: 1, countryOptions: countryOptions, pcOptions: [], statistics: { currencyCode: '', balance: 0, balanceNext: 0, balanceFrozen: 0 }
    }
  },
  created() {
    this.$nextTick(() => {
  ...
  methods: {
    ...
    beforeInit() {
      ...
      this.url = '/payment/channel/wallet/page'
