...
<script>
import { resetAgentLoginPsw, resetAgentDrawPsw } from '@/api/agent'
...
export default {
  ...
  methods: {
    ...
    resetLoginPsw() {
      resetAgentLoginPsw({ id: this.form.id, newPwd: this.form.newPwd, repeatPwd: this.form.repeatPwd }).then(res => {
        this.resetForm()
        this.$notify({
          title: '登录密码重置成功',
          type: 'success',
    ...
    resetDrawPsw() {
      resetAgentDrawPsw({ id: this.form.id, newPwd: this.form.newPwd, repeatPwd: this.form.repeatPwd }).then(res => {
        this.resetForm()
        this.$notify({
          title: '提现密码重置成功',
          type: 'success',
